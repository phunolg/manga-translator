...
from module.utils.panel.kumikolib import Kumiko
...
class TextBlock(object):
    ...
    def get_translation_for_rendering(self):
        from .generic import is_right_to_left_char, is_valuable_char
    ...
    def get_font_colors(self, bgr=False):
        from utils.color import color_difference
    ...
    def stroke_width(self):
        from .generic import color_difference
